...
try:
    ...
    pass
from diffusion_hf import GaussianDiffusionTrainer, GaussianDiffusionSampler, GaussianDiffusionSamplerDDIM
...
from model.model import CelebAHF_UNet
...
def train():
    raise NotImplementedError("Disable training for HF pretrained model!!!")
