...
# data_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), '/mnt/data/imagenet2012/')
...
def get_imagenet_dataloaders(batch_size, val_batch_size, num_workers, data_path="/mnt/data/imagenet2012/",
    ...
    test_loader = get_imagenet_val_loader(val_batch_size, data_path, mean, std)
    return train_loader, test_loader, num_data

def get_imagenet_dataloaders_strong(batch_size, val_batch_size, num_workers, data_path="/mnt/data/imagenet2012/",
    mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]):
...
def get_imagenet_dataloaders_sample(batch_size, val_batch_size, num_workers, k=4096, data_path="/mnt/data/imagenet2012/",
    mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]):
    train_transform = get_imagenet_train_transform(mean, std)
    train_folder = os.path.join(data_path, 'train')
...
def get_imagenet_val_loader(val_batch_size, data_path="/mnt/data/imagenet2012/", mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]):
    test_transform = get_imagenet_test_transform(mean, std)
    test_folder = os.path.join(data_path, 'val')
