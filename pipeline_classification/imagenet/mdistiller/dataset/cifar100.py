...
def get_data_folder(path="../../data"):
    data_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), path)
...
def get_cifar100_dataloaders(batch_size, val_batch_size, num_workers, data_path="../../data/"):
    data_folder = get_data_folder(data_path)
...
def get_cifar100_dataloaders_strong(batch_size, val_batch_size, num_workers, data_path="../../data/"):
    data_folder = get_data_folder(data_path)
...
def get_cifar100_dataloaders_trainval(batch_size, val_batch_size, num_workers, data_path="../../data/"):
    data_folder = get_data_folder(data_path)
    train_transform = get_cifar100_train_transform()
    test_transform = get_cifar100_test_transform()
...
def get_cifar100_dataloaders_val_only(batch_size, val_batch_size, num_workers, data_path="../../data/"):
    data_folder = get_data_folder(data_path)
    train_transform = get_cifar100_train_transform()
    test_transform = get_cifar100_test_transform()
    train_set = CIFAR100Instance(
...
def get_cifar100_dataloaders_train_only(batch_size, val_batch_size, num_workers, data_path="../../data/"):
    data_folder = get_data_folder(data_path)
    train_transform = get_cifar100_train_transform()
    test_transform = get_cifar100_test_transform()
    train_set = CIFAR100Instance(
...
def get_cifar100_dataloaders_sample(
    batch_size, val_batch_size, num_workers, k, mode="exact", data_path="../../data/"
):
    data_folder = get_data_folder(data_path)
    train_transform = get_cifar100_train_transform()
    test_transform = get_cifar100_test_transform()
