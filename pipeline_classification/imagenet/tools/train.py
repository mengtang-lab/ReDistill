...
from mdistiller.engine.utils import load_checkpoint, log_msg, validate
...
def main(cfg, data_path, resume, opts, device_ids=[0]):
    ...
    # distillation
        ...
        # print(log_msg("Validating teacher model", "INFO"))
        # test_acc, test_acc_top5, test_loss = validate(val_loader, torch.nn.DataParallel(model_teacher.cuda(), device_ids=device_ids))
