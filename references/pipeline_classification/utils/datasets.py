...
class ImageNet(Dataset):
    ...
    def __init__(self, path='/mnt/data/imagenet2012/', train_dir=None, val_dir=None, **kwargs):
        ...
        super(ImageNet, self).__init__(path, **kwargs)
...
class TinyImageNet(ImageNet):
    ...
    def __init__(self, path='/mnt/data/tiny-imagenet-200/', **kwargs):
        super(TinyImageNet, self).__init__(path, **kwargs)
